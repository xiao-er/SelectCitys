...
/**
 * file name文件名：HeaderRecyclerAndFooterWrapperAdapter
 * Description 描述：介绍：一个给RecyclerView添加HeaderView FooterView的装饰Adapter类
 * 重点哦~ RecyclerView的HeaderView将可以被系统回收，不像老版的HeaderView是一个强引用在内存里
 * Created time 创建时间：2017/12/8 15:51
 * author 作者：潇潇
